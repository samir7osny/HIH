                ...
                <div class="rightBox">
                        <div class="tableCell">
                                <h1><a
                                        ...
                                        onMouseOut="this.style.color='#bdb3f3'" style="color:#bdb3f3;" href="/user/{{$user->user->username}}">{{$user->user->first_name." " . $user->user->last_name}}</a> have enrolled in "{{$workshop->name}}" Workshop</h1>
