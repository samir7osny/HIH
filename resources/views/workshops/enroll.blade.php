...
@section('content')
{!! Form::open(['action' => ['WorkshopsController@enrollWithAnswers',  $workshop->name], 'method' => 'POST', 'enctype' => 'multipart/form-data', 'class' => 'outerBox windowHeight']) !!}
        @csrf
        <div class="innerBox">
                <div class="rightBox">
                        <div class="tableCell">
                                <h1>Enroll in "{{$workshop->name}}" Workshop</h1>
